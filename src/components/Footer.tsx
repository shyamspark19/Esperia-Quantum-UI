...
interface FooterProps {
  activePage?: 'home' | 'what-we-do' | 'why-esperia' | 'works' | 'watermelon' | 'blogs' | 'contact';
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-14">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-3 text-[14px] text-[#333333] font-manrope font-normal">
              <li className="hover:text-[#E63956] transition-colors cursor-pointer">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                href="#twitter"
                className="w-8 h-8 rounded-full border border-black/10 flex items-center justify-center text-slate-800 hover:bg-[#E63956] hover:text-white hover:border-[#E63956] transition-all"
        ...
        <div className="pt-6 border-t border-black/[0.07] flex flex-col sm:flex-row items-center justify-between gap-4 text-[12px] text-[#000000] font-manrope">
          ...
          <div className="flex items-center gap-6">
            <a
              href="#privacy"
              className="hover:text-[#E63956] transition-colors"
            >
              Privacy Policy
            </a>
            <a
