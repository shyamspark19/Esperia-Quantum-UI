...
export default function IrisHrDetailPage({
  onBack,
  onNavigateToHome,
  onNavigateToContact,
      ...
      <main className="flex-1 w-full max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-20 pt-6 pb-20">
        ...
        <section className="mb-16 sm:mb-20">
          <div className="relative w-full aspect-[16/9] sm:aspect-[2.15/1] bg-[#0A0A0A] rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl flex items-center justify-center group cursor-pointer border border-neutral-900">
            <img src="/assets/figma/exact_iris_hr_hq.png" alt="IRIS HR presentation" className="absolute inset-0 w-full h-full object-cover opacity-70" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#F4F4F1] rounded-2xl p-4 sm:p-5 flex flex-col justify-between border border-slate-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <button type="button" onClick={() => onViewTasConnect ? onViewTasConnect() : onBack()} className="inline-flex items-center gap-1 text-[13px] font-semibold text-[#C5445A] hover:text-[#9e2e41] transition-colors cursor-pointer">
                  <span>View Details</span><span className="text-xs">&gt;</span>
                </button>
              </div>
            </div>
